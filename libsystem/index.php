      ...
      <div class="login-panel">
        ...
        <div class="login-body">
          <ul class="nav nav-pills nav-justified mb-3" id="loginTabs">
            <li class="nav-item">
              <button class="nav-link active" data-bs-toggle="pill" data-bs-target="#student-login">User</button>
            </li>
            <li class="nav-item">
              <button class="nav-link" data-bs-toggle="pill" data-bs-target="#admin-login">Admin</button>
            </li>
          </ul>
          ...
          <div class="tab-content">
            <div class="tab-pane fade show active" id="student-login">
              <form method="POST" action="login.php">
                <input type="text" class="form-control mb-2" name="student" placeholder="Student ID" required>
          ...
          <?php if(isset($_SESSION['error'])): ?>
            <div class="alert alert-danger mt-2 small"><?= $_SESSION['error']; unset($_SESSION['error']); ?></div>
          <?php endif; ?>
        </div>
      </div>
    </div>
